    ...
    <div class="row " style="height: 700px;">
        <div class="col-md " style="margin-top: -10px;">
            <div class="text-center text-gray-900 ">
                <h4 style="font-size: 45px;">OBAT NON RACIKAN</h4>
                <h1 style="font-size: 300px;">C
                    <?php echo $antrianbpjs_non_racikan['no_antrian']; ?>
                    <?php if ($antrianbpjs_non_racikan['no_antrian'] < 1) {
                        $antri = 0;
                    } else {
                        $antri = $antrianbpjs_non_racikan['no_antrian'];
                    }
                    ?>
                </h1>
